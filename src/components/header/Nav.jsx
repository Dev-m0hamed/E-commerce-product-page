...
function Nav() {
  ...
  return (
    <div className="flex gap-5 items-center md:gap-8">
      ...
      ></div>
      <nav
        className={`fixed h-screen w-[70%] top-0 right-full p-5 pt-[30px] bg-white z-50 md:static md:translate-x-0 md:size-auto md:p-0 transition duration-300 md:transition-none ${
      ...
      >
        ...
        <ul className="flex flex-col gap-5 font-bold pt-10 md:flex-row md:p-0 md:text-grayish-blue md:font-normal md:gap-6">
          <li>
            <a
              href="#"
